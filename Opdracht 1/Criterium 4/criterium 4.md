...
## Sprintplanning en realisatieoverzicht
...
## Opgemerkte afwijkingen

- Doordat er 1 teamlid afwezig was op maandag, begon het ontwikkelwerk pas laat.
- Woensdag was diezelde teamlid afwezig, wat de voortgang vertraagde. Hij is wel thuis aan de slag gegaan.
- De fetch-koppeling met MongoDB nam meer tijd in beslag dan verwacht.
- Enkele extra functies zijn bewust laten vallen op woensdag, om de core af te krijgen.
- Donderdag en vrijdag is er gefocust op het werkende krijgen van de alle belangrijkste functionaliteiten. 
- Op vrijdag zijn alle resterende user stories buiten scope geplaatst, zodat we tenminste de belangrijkste functie konden presenteren.

## Bijgestuurde acties

- Op dinsdag extra tijd genomen voor kennisoverdracht in plaats van direct starten met coderen zodat we snapten wat er moest gebeuren.
- Woensdag prioriteiten herzien: alleen contactroulette en werkende PWA werden nog opgepakt.
- Donderdag en vrijdag gericht gefocust op één werkende versie, in plaats van losse losse componenten. Zo hadden we iets om te presenteren.
